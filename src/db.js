...
db.version(10.5).stores({
    ...
    students: "++id, studID, studName, firstName, lastName, otherName, gender, phone, email, educationLevel, schoolName, schoolAddress, pointsBalance, Results, accountCreatedDate, accountStatus"
});
