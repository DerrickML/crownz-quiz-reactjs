...
import './Packages2.css'; // This should contain the necessary CSS styles

const Packages2 = ({ studentInfo }) => {
    ...
    return (
        <div className="justify-content-center my-5" style={{ marginTop: '100px', backgroundColor: 'hsl(240, 78%, 98%)' }}>
