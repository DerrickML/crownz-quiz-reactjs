...
//                 numQuestions = 3;
//             }
//             if (categoryId === 16 || categoryId === 21 || categoryId === 23 || categoryId === 25 || categoryId === 27 || categoryId === 29) {
//                 numQuestions = 2;
//             }
...
export const selectRandomQuestions = (questionsData, categoryIds, subjectName, userHistory, userId, educationLevel) => {
    let updatedUserHistory = {
        userId,
        subjectName,
        questionsJSON: { ...userHistory?.questionsJSON },
        educationLevel,
    };
    ...
    const selectQuestionsForCategory = (categoryId) => {
        ...
        const isCategoryExhausted = attemptedQuestionIds.length === allQuestionIds.length;
